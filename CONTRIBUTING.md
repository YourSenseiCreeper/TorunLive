...
[fork]: /fork
[pr]: /compare
[style]: https://google.github.io/styleguide/csharp-style.html
...
1. Rebuild solution in Visual Studio or by typing in solution folder: `dotnet build --no-incremental`.
1. Make sure the tests pass on your machine in Visual Studio or by typing: `dotnet test`
